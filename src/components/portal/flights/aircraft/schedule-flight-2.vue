<template>
    <div class="d-flex flex-column flex-grow-1">
        <h1 class="px-3 py-2 text-uppercase d-flex align-items-center">
            <span class="fw-bold pe-1">2. Choose</span>
            <span class="fw-light flex-grow-1">Flight</span>
        </h1>
        <article class="flex-grow-1 vstack gap-3">
            <div
            ...
            >
                <div class="hstack m-3 p-2 bg-light-subtle">
                    <div class="col-5 vstack text-center">
                        <div>{{ itinerary.origin_start_time }}</div>
                        <div class="h4 pt-2">
                    ...
                    <div class="col-5 vstack text-center">
                        <div>{{ itinerary.target_start_time }}</div>
                        <div class="h4 pt-2">
                ...
                <div v-else class="text-center py-2">
                    <button
                        class="btn btn-primary shadow py-0"
        ...
        <footer
            data-bs-theme="dark"
            class="d-flex align-self-bottom p-2 rounded-top mt-3"
        >
