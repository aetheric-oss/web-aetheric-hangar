                ...
                <div class="d-flex gap-1 mb-1 align-items-start">
                    <div class="d-flex flex-column">
                        ...
                        <div class="d-flex gap-1">
                            ...
                            <button
                                class="btn btn-icon text-white fs-5 my-auto lh-0"
                                @click="toggleMaskedStatus(index)"
                            >
                                <IconEye :size="18" v-show="info.isMasked" />
                                <IconEyeSlash
                                    :size="18"
                                    v-show="!info.isMasked"
                                />
                            </button>
                            <button
                                class="btn btn-icon fs-4 ms-1 me-2 lh-0"
...
<script setup>
    ...
    const formattedPaymentInfo = reactive(
